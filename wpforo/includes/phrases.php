...
$wpforo_phrases = [
	...
	//Beta-5
	'Dashboard - Manage Boards & Forums' => __('Dashboard - Manage Boards & Forums', 'wpforo'),
	...
	'Can leave voice posts' => __('Can leave voice posts', 'wpforo'),
	'Can listen voice posts' => __('Can listen voice posts', 'wpforo'),
	...
	'This topic will be private' => __('This topic will be private', 'wpforo'),
	...
	"What's New" => __("What's New", 'wpforo'),
	'Recent Activity' => __('Recent Activity', 'wpforo'),
	'All Activities' => __('All Activities', 'wpforo'),
	'Last 24 Hours' => __('Last 24 Hours', 'wpforo'),
	'Last Week' => __('Last Week', 'wpforo'),
	'Last Month' => __('Last Month', 'wpforo'),
	'All Time' => __('All Time', 'wpforo'),
	'No activities found' => __('No activities found', 'wpforo'),
	'edited a topic' => __('edited a topic', 'wpforo'),
	'edited a post' => __('edited a post', 'wpforo'),
	'replied to' => __('replied to', 'wpforo'),
	'liked' => __('liked', 'wpforo'),
	'disliked' => __('disliked', 'wpforo'),
	'voted up' => __('voted up', 'wpforo'),
	'voted down' => __('voted down', 'wpforo'),
	'reacted to' => __('reacted to', 'wpforo'),
	'mentioned in' => __('mentioned in', 'wpforo'),
	'activity' => __('activity', 'wpforo'),
	'View' => __('View', 'wpforo'),
	'created the topic' => __('created the topic', 'wpforo'),
	'created the topic %1$s in %2$s' => __('created the topic %1$s in %2$s', 'wpforo'),
	'replied to the topic %s' => __('replied to the topic %s', 'wpforo'),
	'reacted to %1$s\'s post in the topic %2$s' => __('reacted to %1$s\'s post in the topic %2$s', 'wpforo'),
	'reacted to a post in the topic %s' => __('reacted to a post in the topic %s', 'wpforo'),
	'favorited %1$s\'s post in the topic %2$s' => __('favorited %1$s\'s post in the topic %2$s', 'wpforo'),
	'favorited a post in the topic %s' => __('favorited a post in the topic %s', 'wpforo'),
	'favorited' => __('favorited', 'wpforo'),
	'marked as solved the topic %s' => __('marked as solved the topic %s', 'wpforo'),
	'marked as solved' => __('marked as solved', 'wpforo'),
	'closed the topic %s' => __('closed the topic %s', 'wpforo'),
	'closed the topic' => __('closed the topic', 'wpforo'),
	'marked as answer a post in the topic %s' => __('marked as answer a post in the topic %s', 'wpforo'),
	'marked as answer' => __('marked as answer', 'wpforo'),
	'Marked as Answer' => __('Marked as Answer', 'wpforo'),
	'mentioned you in %s' => __('mentioned you in %s', 'wpforo'),
	'edited a post in %s' => __('edited a post in %s', 'wpforo'),
	'Load More Activities' => __('Load More Activities', 'wpforo'),
	...
	'Settings &gt; Spam Protection Tab'  => __('Settings &gt; Spam Protection Tab', 'wpforo'),
	...
	'You have been automatically signed out from the website. Your account is awaiting approval.'  => __('You have been automatically signed out from the website. Your account is awaiting approval.', 'wpforo'),
    ...
    // AI Features & 2026 Theme Phrases
    'Chat'  => __('Chat', 'wpforo'),
    'Preferences'  => __('Preferences', 'wpforo'),
    'AI Search'  => __('AI Search', 'wpforo'),
    'Classic Search'  => __('Classic Search', 'wpforo'),
    'Describe what you\'re looking for...'  => __('Describe what you\'re looking for...', 'wpforo'),
    'More Results'  => __('More Results', 'wpforo'),
    'Conversations'  => __('Conversations', 'wpforo'),
    'New Conversation'  => __('New Conversation', 'wpforo'),
    'Start a new conversation or select an existing one'  => __('Start a new conversation or select an existing one', 'wpforo'),
    'Type your message...'  => __('Type your message...', 'wpforo'),
    'AI Features Preferences'  => __('AI Features Preferences', 'wpforo'),
    'AI Features Response Language'  => __('AI Features Response Language', 'wpforo'),
    'AI will generate responses in this language'  => __('AI will generate responses in this language', 'wpforo'),
    'Maximum Number of Search Results'  => __('Maximum Number of Search Results', 'wpforo'),
    'Number of search results to display (1-10)'  => __('Number of search results to display (1-10)', 'wpforo'),
    'Save Preferences'  => __('Save Preferences', 'wpforo'),
    'AI Assistant'  => __('AI Assistant', 'wpforo'),
    'Recent Activity Timeline'  => __('Recent Activity Timeline', 'wpforo'),
    'All Activities'  => __('All Activities', 'wpforo'),
    'Reactions'  => __('Reactions', 'wpforo'),
    'Favorites'  => __('Favorites', 'wpforo'),
    'Marked as Answer'  => __('Marked as Answer', 'wpforo'),
    'Last 24 Hours'  => __('Last 24 Hours', 'wpforo'),
    'All Time'  => __('All Time', 'wpforo'),
    'Delete Activity'  => __('Delete Activity', 'wpforo'),
    'Loading...'  => __('Loading...', 'wpforo'),
    'Load More Activities'  => __('Load More Activities', 'wpforo'),
    'No activities found'  => __('No activities found', 'wpforo'),
    'Are you sure you want to delete this activity?'  => __('Are you sure you want to delete this activity?', 'wpforo'),
    'Failed to delete activity'  => __('Failed to delete activity', 'wpforo'),

    // AI Moderation
    'Cron Job'  => __('Cron Job', 'wpforo'),
    'System'  => __('System', 'wpforo'),
    'AI Moderation Report'  => __('AI Moderation Report', 'wpforo'),
    'Moderation Report'  => __('Moderation Report', 'wpforo'),
    'Type:'  => __('Type:', 'wpforo'),
    'Score:'  => __('Score:', 'wpforo'),
    '%d%% confidence'  => __('%d%% confidence', 'wpforo'),
    'Action:'  => __('Action:', 'wpforo'),
    'Summary:'  => __('Summary:', 'wpforo'),
    'Indicators:'  => __('Indicators:', 'wpforo'),
    'AI Quality:'  => __('AI Quality:', 'wpforo'),
    'credit'  => __('credit', 'wpforo'),
    'credits'  => __('credits', 'wpforo'),
    'Clean'  => __('Clean', 'wpforo'),
    'Detected'  => __('Detected', 'wpforo'),
    'Suspected'  => __('Suspected', 'wpforo'),
    'Uncertain'  => __('Uncertain', 'wpforo'),
    'No action'  => __('No action', 'wpforo'),
    'Auto-approved'  => __('Auto-approved', 'wpforo'),
    'Unapproved + Banned'  => __('Unapproved + Banned', 'wpforo'),
    'Deleted + Banned'  => __('Deleted + Banned', 'wpforo'),
    'Spam Detection'  => __('Spam Detection', 'wpforo'),
    'Toxicity Detection'  => __('Toxicity Detection', 'wpforo'),
    'Policy Compliance'  => __('Policy Compliance', 'wpforo'),
    'Auto Moderation'  => __('Auto Moderation', 'wpforo'),
    'AI Spam Detection'  => __('AI Spam Detection', 'wpforo'),
    'AI Content Safety & Toxicity Detection'  => __('AI Content Safety & Toxicity Detection', 'wpforo'),
    'AI Policy Compliance'  => __('AI Policy Compliance', 'wpforo'),
    'AI Content Moderation'  => __('AI Content Moderation', 'wpforo'),
    'Fast'  => __('Fast', 'wpforo'),
    'Balanced'  => __('Balanced', 'wpforo'),
    'Advanced'  => __('Advanced', 'wpforo'),
    'Premium'  => __('Premium', 'wpforo'),
    'Rule-based'  => __('Rule-based', 'wpforo'),

    // AI Search
    'Excellent match'  => __('Excellent match', 'wpforo'),
    'Good match'  => __('Good match', 'wpforo'),
    'Relevant'  => __('Relevant', 'wpforo'),
    'Possibly relevant'  => __('Possibly relevant', 'wpforo'),
    'AI Recommendations'  => __('AI Recommendations', 'wpforo'),

    // AI Translation
    'Translate this post'  => __('Translate this post', 'wpforo'),
    'Translate'  => __('Translate', 'wpforo'),
    'Show original'  => __('Show original', 'wpforo'),
    'Translating...'  => __('Translating...', 'wpforo'),
    'English'  => __('English', 'wpforo'),
    'Spanish'  => __('Spanish', 'wpforo'),
    'French'  => __('French', 'wpforo'),
    'German'  => __('German', 'wpforo'),
    'Italian'  => __('Italian', 'wpforo'),
    'Portuguese'  => __('Portuguese', 'wpforo'),
    'Russian'  => __('Russian', 'wpforo'),
    'Chinese'  => __('Chinese', 'wpforo'),
    'Japanese'  => __('Japanese', 'wpforo'),
    'Korean'  => __('Korean', 'wpforo'),
    'Arabic'  => __('Arabic', 'wpforo'),
    'Hindi'  => __('Hindi', 'wpforo'),
    'Dutch'  => __('Dutch', 'wpforo'),
    'Polish'  => __('Polish', 'wpforo'),
    'Turkish'  => __('Turkish', 'wpforo'),
    'Vietnamese'  => __('Vietnamese', 'wpforo'),
    'Thai'  => __('Thai', 'wpforo'),
    'Swedish'  => __('Swedish', 'wpforo'),
    'Danish'  => __('Danish', 'wpforo'),
    'Finnish'  => __('Finnish', 'wpforo'),
    'Norwegian'  => __('Norwegian', 'wpforo'),
    'Czech'  => __('Czech', 'wpforo'),
    'Hungarian'  => __('Hungarian', 'wpforo'),
    'Romanian'  => __('Romanian', 'wpforo'),
    'Greek'  => __('Greek', 'wpforo'),
    'Hebrew'  => __('Hebrew', 'wpforo'),
    'Indonesian'  => __('Indonesian', 'wpforo'),
    'Malay'  => __('Malay', 'wpforo'),
    'Ukrainian'  => __('Ukrainian', 'wpforo'),
    'Bulgarian'  => __('Bulgarian', 'wpforo'),
    'Croatian'  => __('Croatian', 'wpforo'),
    'Slovak'  => __('Slovak', 'wpforo'),
    'Slovenian'  => __('Slovenian', 'wpforo'),
    'Serbian'  => __('Serbian', 'wpforo'),
    'Lithuanian'  => __('Lithuanian', 'wpforo'),
    'Latvian'  => __('Latvian', 'wpforo'),
    'Estonian'  => __('Estonian', 'wpforo'),

    // AI Summarization
    'Summarize Topic'  => __('Summarize Topic', 'wpforo'),
    'AI is analyzing the discussion...'  => __('AI is analyzing the discussion...', 'wpforo'),
    'Compact with Key Points'  => __('Compact with Key Points', 'wpforo'),
    'Structured with Sections'  => __('Structured with Sections', 'wpforo'),
    'Conversational Flow'  => __('Conversational Flow', 'wpforo'),
    'Short Summary + Details'  => __('Short Summary + Details', 'wpforo'),
    'Minimal and Clean'  => __('Minimal and Clean', 'wpforo'),

    // AI Suggestions
    'AI Topic Suggestions'  => __('AI Topic Suggestions', 'wpforo'),
    'This is an AI-generated suggestion based on existing forum content. Please verify the information.'  => __('This is an AI-generated suggestion based on existing forum content. Please verify the information.', 'wpforo'),
